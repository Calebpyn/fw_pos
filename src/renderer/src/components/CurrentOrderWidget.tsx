...
function CurrentOrderWidget() {
  ...
  return (
    <div
      className="h-full w-full radial-current-order rounded-3xl p-5 flex justify-between items-center relative"
      style={{ font: 'Inter' }}
    >
      <div className="h-full flex flex-col justify-between w-64">
        <div className="overflow-y-auto hide-sb">
          ...
          <div className="flex flex-col w-full">
            <div
              className="text-white flex justify-start items-center"
              onClick={() => {
            ...
            >
              <IoIosArrowForward
                className={
                  isActiveOpen
                    ? 'text-xl hover:text-gray-400 rounded-full transitions rotate-45-c'
                    : 'text-xl hover:text-gray-400 rounded-full transitions'
                }
              />
              <span className="hover:text-gray-400 mx-2 font-light transitions select-none">
                Active Orders
              </span>
            ...
            <div
              className={
                isActiveOpen
                  ? 'w-full transitions h-360 overflow-y-auto pl-5'
                  : 'w-full h-0 transitions overflow-y-auto'
              }
            >
              {/* Active Orders */}
                ...
                <div key={item.id}>
                  {!item.delivered ? (
                    <div className={isActiveOpen ? '' : 'text-transparent'}>
                      <div
                        className="flex justify-between w-full text-white pt-2 items-center select-none"
                        onClick={() => {
                      ...
                      <div
                        className={
                          item.id == activeSelction
                            ? 'w-full transitions h-40 overflow-y-auto pl-5'
                            : 'w-full h-0 transitions overflow-y-auto'
                        }
                      >
                        <div className={item.id == activeSelction ? '' : 'hidden'}>
                            ...
                            <div key={productIndex} className="flex flex-col">
                              <div className="flex justify-between w-full select-none">
                                <span
                                  className={
                                    product.sent
                                      ? 'flex items-center font-extralight text-12 text-blue-300 line-through'
                                      : 'flex items-center text-white font-extralight text-12'
                                  }
                                  onClick={() => {
                                    updateSentState(itemIndex, productIndex)
                                  }}
                                >
                                  {<GoDotFill className="text-4 mr-1" />}
                                  {product.name}
                                </span>
                                <span className="font-extralight text-12 text-white">
                                  ${product.price}
                                </span>
                              </div>
                              {product.modifiers.map((mod, modIndex) => (
                                <div
                                  key={modIndex}
                                  className="text-white font-extralight flex items-center justify-between"
                                >
                                  <div className="flex items-center">
                                    ...
                                    <span
                                      className={
                                        product.sent
                                          ? 'ml-1 text-12 text-blue-300 line-through'
                                          : 'ml-1 text-12'
                                      }
                                    >
                                      {mod.name}
                          ...
                          <div className="text-white text-10 mt-2">
                            <button className="bg-black bg-opacity-30 items-center text-white px-2 py-1 rounded-lg hover:bg-opacity-40 transitions mr-2">
                              Edit
                            </button>
                            <button
                              className="bg-black bg-opacity-30 items-center text-white px-2 py-1 rounded-lg hover:bg-opacity-40 transitions mr-2"
                              onClick={() => updateDeliveredState(itemIndex, true)}
                            >
                              Send
                            </button>
                          </div>
          ...
          <div className="">
            <div
              className="text-white flex justify-start items-center mt-3"
              onClick={() => {
                      ...
                      >
                        <div className={item.id == activeSelction ? '' : 'hidden'}>
                          {item.items.map((product, productIndex) => (
                            <div key={productIndex} className="flex flex-col">
                              <div className="flex justify-between w-full select-none">
                                ...
                                <span className="font-extralight text-10 text-white">
                                  ${product.price}
                                </span>
                              </div>
                              {product.modifiers.map((mod, modIndex) => (
                          ...
                          <div className="text-white text-10 mt-2">
                            ...
                            <button
                              className="bg-black bg-opacity-30 items-center text-white px-2 py-1 rounded-lg hover:bg-opacity-40 transitions mr-2"
                              onClick={() => updateDeliveredState(itemIndex, false)}
                            >
                              Active
                            </button>
                          </div>
